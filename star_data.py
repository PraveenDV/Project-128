...
def scrape():
        ...
        bright_stars_table=soup.find("table", attrs={"class":"wikitable sortable jquery-tablesorter"})
        table_body=bright_stars_table.find("tbody")
        table_rows=bright_stars_table.find_all("tr")
